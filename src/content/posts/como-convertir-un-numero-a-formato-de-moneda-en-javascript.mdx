...
Por ejemplo:
Si tenemos el precio de un producto como **2300.80** y queremos representar como un valor de precio como **$2,300.80**, el método Intl.NumberFormat() nos permite formatear a un valor más legible.
Los ejemplos de abajo son funciones para formatear un valor a un valor dolar, euro y yen.
